...
SECRET_KEY = '4cvm3bqnr@y_gtnb%-)8x%tiwxwcz8p-dvuvrpgw7&su_$8w9&'
...
INSTALLED_APPS = [
    'E_Events.apps.E_EventsConfig',
    # App configuration added from
    # app.py class from E_Events

    'users.apps.UsersConfig',
    # App configuration added from
    # app.py class from USERS
